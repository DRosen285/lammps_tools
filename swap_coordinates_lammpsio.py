...
def write_new_data(pos_array_swap,MACE=False):
    ...
    if MACE:
       datafile = lammpsio.DataFile('/home/drosenbe/run_EC_LiPF6/reactive_system/swap_potentials/lammps_settings/mixture_MACE.data', atom_style='atomic')
       ...
       datafile = lammpsio.DataFile('/home/drosenbe/run_EC_LiPF6/reactive_system/swap_potentials/lammps_settings/mixture_classical.data', atom_style='full')
       snapshot= datafile.read()
       snapshot.position=pos_array_swap
       new_snapshot= lammpsio.Snapshot(
                     snapshot.N,
       ...
       new_snapshot.typeid=snapshot.typeid
       new_snapshot.type_label=snapshot.type_label
       lammpsio.DataFile.create('mixture_classical_XXX.data',new_snapshot,atom_style='full')
